...
DEFAULT_MODEL_ROOT = REPO_ROOT / "FLUX.1-Kontext-dev"
DEFAULT_GT_ROOT = REPO_ROOT / "datasets" / "P3M-10k"
DEFAULT_FILE_LIST = REPO_ROOT / "data_split" / "P3M_matting" / "filenames_val_NP.txt"
